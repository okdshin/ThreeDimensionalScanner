...
def main():
    ...
    is_compile_success = os.system("g++ -D UNIT_TEST -std=gnu++0x -g -Wall -O3 -lboost_serialization -I/usr/include/opencv2 -lx264 -lopencv_core -lopencv_highgui -lopencv_imgproc {target}.cpp -o unit_test.out".format(target = target_name))
